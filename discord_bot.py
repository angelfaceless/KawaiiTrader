...
from formatters.markdown_formatter_discord import format_report_discord  # ✅ Discord-specific formatting

# Load environment variables
load_dotenv()
TOKEN = os.getenv("DISCORD_BOT_TOKEN")

# 🔁 Support multiple allowed channels (comma-separated IDs)
